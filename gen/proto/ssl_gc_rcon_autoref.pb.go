...
func (x *AutoRefRegistration) Reset() {
	*x = AutoRefRegistration{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[0]
...
func (*AutoRefRegistration) Descriptor() ([]byte, []int) {
	return file_rcon_ssl_gc_rcon_autoref_proto_rawDescGZIP(), []int{0}
}
...
func (x *AutoRefToController) Reset() {
	*x = AutoRefToController{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AutoRefToController) Descriptor() ([]byte, []int) {
	return file_rcon_ssl_gc_rcon_autoref_proto_rawDescGZIP(), []int{1}
}
...
func (x *ControllerToAutoRef) Reset() {
	*x = ControllerToAutoRef{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ControllerToAutoRef) Descriptor() ([]byte, []int) {
	return file_rcon_ssl_gc_rcon_autoref_proto_rawDescGZIP(), []int{2}
}
...
var File_rcon_ssl_gc_rcon_autoref_proto protoreflect.FileDescriptor

var file_rcon_ssl_gc_rcon_autoref_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x72, 0x63, 0x6f, 0x6e, 0x2f, 0x73, 0x73, 0x6c, 0x5f, 0x67, 0x63, 0x5f, 0x72, 0x63,
	0x6f, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x6f, 0x72, 0x65, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x1d, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2f, 0x73, 0x73, 0x6c, 0x5f, 0x67, 0x63, 0x5f, 0x67,
	0x61, 0x6d, 0x65, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	0x16, 0x72, 0x63, 0x6f, 0x6e, 0x2f, 0x73, 0x73, 0x6c, 0x5f, 0x67, 0x63, 0x5f, 0x72, 0x63, 0x6f,
	...
	0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x05, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x42, 0x30, 0x5a,
...
var (
	file_rcon_ssl_gc_rcon_autoref_proto_rawDescOnce sync.Once
	file_rcon_ssl_gc_rcon_autoref_proto_rawDescData = file_rcon_ssl_gc_rcon_autoref_proto_rawDesc
)

func file_rcon_ssl_gc_rcon_autoref_proto_rawDescGZIP() []byte {
	file_rcon_ssl_gc_rcon_autoref_proto_rawDescOnce.Do(func() {
		file_rcon_ssl_gc_rcon_autoref_proto_rawDescData = protoimpl.X.CompressGZIP(file_rcon_ssl_gc_rcon_autoref_proto_rawDescData)
	})
	return file_rcon_ssl_gc_rcon_autoref_proto_rawDescData
}

var file_rcon_ssl_gc_rcon_autoref_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_rcon_ssl_gc_rcon_autoref_proto_goTypes = []interface{}{
...
var file_rcon_ssl_gc_rcon_autoref_proto_depIdxs = []int32{
...
func init() { file_rcon_ssl_gc_rcon_autoref_proto_init() }
func file_rcon_ssl_gc_rcon_autoref_proto_init() {
	if File_rcon_ssl_gc_rcon_autoref_proto != nil {
		return
	}
	file_state_ssl_gc_game_event_proto_init()
	file_rcon_ssl_gc_rcon_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_rcon_ssl_gc_rcon_autoref_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rcon_ssl_gc_rcon_autoref_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_rcon_ssl_gc_rcon_autoref_proto_goTypes,
		DependencyIndexes: file_rcon_ssl_gc_rcon_autoref_proto_depIdxs,
		MessageInfos:      file_rcon_ssl_gc_rcon_autoref_proto_msgTypes,
	}.Build()
	File_rcon_ssl_gc_rcon_autoref_proto = out.File
	file_rcon_ssl_gc_rcon_autoref_proto_rawDesc = nil
	file_rcon_ssl_gc_rcon_autoref_proto_goTypes = nil
	file_rcon_ssl_gc_rcon_autoref_proto_depIdxs = nil
}
