...
var file_rcon_ssl_gc_rcon_remotecontrol_proto_rawDesc = []byte{
	...
	0x4c, 0x41, 0x43, 0x45, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x07, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69,
...
var file_rcon_ssl_gc_rcon_remotecontrol_proto_goTypes = []interface{}{
...
func file_rcon_ssl_gc_rcon_remotecontrol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rcon_ssl_gc_rcon_remotecontrol_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_remotecontrol_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_remotecontrol_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_remotecontrol_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_rcon_ssl_gc_rcon_remotecontrol_proto_msgTypes[1].OneofWrappers = []interface{}{
