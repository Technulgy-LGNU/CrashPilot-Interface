...
type StateChange struct {
	...
	// The previous state
	StatePre *State `protobuf:"bytes,2,opt,name=state_pre,json=statePre" json:"state_pre,omitempty"`
...
func (x *StateChange) GetStatePre() *State {
	if x != nil {
		return x.StatePre
	}
	return nil
...
func (x *Change) GetSetStatusMessageChange() *Change_SetStatusMessage {
	if x, ok := x.GetChange().(*Change_SetStatusMessageChange); ok {
...
func (x *Change_NewCommand) GetCommand() *Command {
	if x != nil {
		return x.Command
	}
	return nil
...
type Change_ChangeStage struct {
	...
	// The new stage
	NewStage *Referee_Stage `protobuf:"varint,1,opt,name=new_stage,json=newStage,enum=Referee_Stage" json:"new_stage,omitempty"`
}
...
func (x *Change_ChangeStage) GetNewStage() Referee_Stage {
...
type Change_SetBallPlacementPos struct {
	...
	// The position in [m]
	Pos *Vector2 `protobuf:"bytes,1,opt,name=pos" json:"pos,omitempty"`
}
...
func (x *Change_SetBallPlacementPos) GetPos() *Vector2 {
	if x != nil {
		return x.Pos
	}
	return nil
...
type Change_AddYellowCard struct {
	...
	ForTeam *Team `protobuf:"varint,1,opt,name=for_team,json=forTeam,enum=Team" json:"for_team,omitempty"`
...
func (x *Change_AddYellowCard) GetForTeam() Team {
...
func (x *Change_AddYellowCard) GetCausedByGameEvent() *GameEvent {
	if x != nil {
...
func (x *Change_AddRedCard) GetForTeam() Team {
	if x != nil && x.ForTeam != nil {
		return *x.ForTeam
	}
	return Team_UNKNOWN
...
func (x *Change_AddRedCard) GetCausedByGameEvent() *GameEvent {
	if x != nil {
		return x.CausedByGameEvent
	}
	return nil
...
func (x *Change_YellowCardOver) GetForTeam() Team {
	if x != nil && x.ForTeam != nil {
		return *x.ForTeam
	}
	return Team_UNKNOWN
...
func (x *Change_AddGameEvent) GetGameEvent() *GameEvent {
	if x != nil {
		return x.GameEvent
	}
	return nil
...
func (x *Change_AddPassiveGameEvent) GetGameEvent() *GameEvent {
	if x != nil {
		return x.GameEvent
	}
	return nil
...
func (x *Change_AddProposal) GetProposal() *Proposal {
	if x != nil {
		return x.Proposal
	}
	return nil
...
type Change_UpdateConfig struct {
	...
	Division *Division `protobuf:"varint,1,opt,name=division,enum=Division" json:"division,omitempty"`
	// the team that does/did the first kick off
	FirstKickoffTeam *Team `protobuf:"varint,2,opt,name=first_kickoff_team,json=firstKickoffTeam,enum=Team" json:"first_kickoff_team,omitempty"`
	// The match type
	MatchType *MatchType `protobuf:"varint,4,opt,name=match_type,json=matchType,enum=MatchType" json:"match_type,omitempty"`
...
func (x *Change_UpdateConfig) GetDivision() Division {
...
func (x *Change_UpdateConfig) GetFirstKickoffTeam() Team {
...
func (x *Change_UpdateConfig) GetMatchType() MatchType {
...
type Change_UpdateTeamState struct {
	...
	YellowCard *YellowCard `protobuf:"bytes,20,opt,name=yellow_card,json=yellowCard" json:"yellow_card,omitempty"`
	// Update a certain red card of the team
	RedCard *RedCard `protobuf:"bytes,12,opt,name=red_card,json=redCard" json:"red_card,omitempty"`
	// Update a certain foul of the team
	Foul *Foul `protobuf:"bytes,13,opt,name=foul" json:"foul,omitempty"`
	...
	HullColor *HullColor `protobuf:"varint,23,opt,name=hull_color,json=hullColor,enum=HullColor" json:"hull_color,omitempty"`
}
...
func (x *Change_UpdateTeamState) GetForTeam() Team {
	if x != nil && x.ForTeam != nil {
		return *x.ForTeam
	}
	return Team_UNKNOWN
...
func (x *Change_UpdateTeamState) GetYellowCard() *YellowCard {
	if x != nil {
		return x.YellowCard
	}
	return nil
...
func (x *Change_UpdateTeamState) GetRedCard() *RedCard {
	if x != nil {
		return x.RedCard
	}
	return nil
...
func (x *Change_UpdateTeamState) GetFoul() *Foul {
	if x != nil {
		return x.Foul
	}
	return nil
...
func (x *Change_UpdateTeamState) GetHullColor() HullColor {
...
type Change_NewGameState struct {
	...
	// The new game state
	GameState *GameState `protobuf:"bytes,1,opt,name=game_state,json=gameState" json:"game_state,omitempty"`
}
...
func (x *Change_NewGameState) GetGameState() *GameState {
	if x != nil {
		return x.GameState
	}
	return nil
...
var file_statemachine_ssl_gc_change_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74,
...
var file_statemachine_ssl_gc_change_proto_goTypes = []interface{}{
	...
	(Referee_Stage)(0),                 // 21: Referee.Stage
	(*Vector2)(nil),                    // 22: Vector2
	(Team)(0),                          // 23: Team
	(*GameEvent)(nil),                  // 24: GameEvent
	(*Proposal)(nil),                   // 25: Proposal
	(Division)(0),                      // 26: Division
	(MatchType)(0),                     // 27: MatchType
	...
	(*YellowCard)(nil),                 // 31: YellowCard
	(*RedCard)(nil),                    // 32: RedCard
	(*Foul)(nil),                       // 33: Foul
	(*wrapperspb.UInt32Value)(nil),     // 34: google.protobuf.UInt32Value
	(HullColor)(0),                     // 35: HullColor
	(*GameState)(nil),                  // 36: GameState
}
...
func file_statemachine_ssl_gc_change_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_statemachine_ssl_gc_change_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Change); i {
			case 0:
				return &v.state
			case 1:
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_statemachine_ssl_gc_change_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Change_SetStatusMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_statemachine_ssl_gc_change_proto_msgTypes[1].OneofWrappers = []interface{}{
