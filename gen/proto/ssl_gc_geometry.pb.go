...
var file_geom_ssl_gc_geometry_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x02, 0x28, 0x02, 0x52, 0x01, 0x7a, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
...
var file_geom_ssl_gc_geometry_proto_goTypes = []interface{}{
...
func file_geom_ssl_gc_geometry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_geom_ssl_gc_geometry_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_geom_ssl_gc_geometry_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
