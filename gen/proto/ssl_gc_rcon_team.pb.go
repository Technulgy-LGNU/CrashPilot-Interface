...
var file_rcon_ssl_gc_rcon_team_proto_rawDesc = []byte{
	...
	0x12, 0x0c, 0x0a, 0x08, 0x43, 0x4f, 0x4e, 0x54, 0x49, 0x4e, 0x55, 0x45, 0x10, 0x01, 0x42, 0x30,
...
var file_rcon_ssl_gc_rcon_team_proto_goTypes = []interface{}{
...
func file_rcon_ssl_gc_rcon_team_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rcon_ssl_gc_rcon_team_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_team_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rcon_ssl_gc_rcon_team_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_rcon_ssl_gc_rcon_team_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	file_rcon_ssl_gc_rcon_team_proto_msgTypes[2].OneofWrappers = []interface{}{
